...
<Tabs>
  ...
  <TabItem value="ssl" label="SSL/HTTPS">
    ...
    - `aws_image_region` is the [region][AWS regions] where webservice [AMI][AWS AMI] will be published to. The
...
[Sentry Data Source Name (Sentry DSN)]: https://qubitpi.github.io/sentry-docs/product/sentry-basics/concepts/dsn-explainer/?original_referrer=https%3A%2F%2Fgithub.com%2F
