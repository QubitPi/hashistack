...
<Tabs>
  <TabItem value="alicloud" label="Alicloud" default>
    ...
    **[immutable-infrastructure-as-a-service/hashicorp/kong-api-gateway/images]** directory with the following contents:
    ...
    ```hcl title="immutable-infrastructure-as-a-service/hashicorp/kong-api-gateway/images/ali-kong.auto.pkrvars.hcl"
    ...
    - `ali_image_name` is the [Alicloud ECS] image name, which can be either English or Chinese characters. It can begin
      with an uppercase/lowercase letter or a Chinese character, and may contain numbers, `_` or `-`, but cannot begin
      with `http://` or `https://`
    ...
    - `ssl_cert_source` is the absolute path or the path relative to
      ...
      [SSL certificate file](../setup#ssl) for the Kong API Gateway domain
...
<Tabs>
  <TabItem value="alicloud" label="Alicloud" default>
    ...
    **[immutable-infrastructure-as-a-service/hashicorp/kong-api-gateway/instances]** directory with the following
    contents:
  ...
  <TabItem value="aws" label="AWS">
    ...
    **[immutable-infrastructure-as-a-service/hashicorp/kong-api-gateway/instances]** directory with the following
    ...
    ```hcl title="immutable-infrastructure-as-a-service/hashicorp/kong-api-gateway/instances/aws-kong.auto.tfvars"
...
[Kong manager UI]:https://docs.konghq.com/gateway/latest/kong-manager/
